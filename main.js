document.querySelector("form").addEventListener("submit", (event) => {
    ...
    //main filled with relevant info
...
document.querySelector(".view").textContent = ""
    ...
    // shows the next few says
    const history = document.querySelector(".history p").classList.add("this")
    document.querySelector(".history").innerHTML += `${input} - ${currently}`
